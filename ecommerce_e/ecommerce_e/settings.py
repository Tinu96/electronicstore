"""
Django settings for ecommerce_e project.
...
SECRET_KEY = 'django-insecure-*cuwgn&cv4(t36m%k5d_%d)jo@q5=-7q_2q&qpn2uk(gr5av$s'
...
WSGI_APPLICATION = 'ecommerce_e.wsgi.application'
